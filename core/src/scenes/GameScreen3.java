...
public class GameScreen3 implements Screen {
    ...
    private int enemigosAsesinados2;
    ...
    public GameScreen3(Game juego,PartidaInfo partidaInfo,Player player1,int enemigosAsesinados) {
        this.juego = juego;
        ...
        this.enemigosAsesinados2=enemigosAsesinados;
        ...
        mapa = manager.get("mapas/nivel3.tmx", TiledMap.class);
        ...
        for (MapObject object : enemigos) {
            if (object.getProperties().get("type", String.class).equals("Slime")) {
                ...
                Slime3 slime = new Slime3(x,y,collisionLayer);
        ...
        player = new Player(800, 800,collisionLayer);
    ...
    public void render(float delta) {
        ...
        if (player.morir()) {
            ...
            player.reiniciar();
            fondoSound.stop();
            ApiClient.actualizarEnemigos(partidaInfo.getPartidaId(), enemigosAsesinados2, new ApiListener() {
                @Override
    ...
    private void checkCollisions() {
                ...
                if(cofre.isAbierto()){
                    ApiClient.actualizarInventario(partidaInfo.getInventarioId(), 2, partidaInfo.getPartidaId(), new ApiListener() {
                        ...
                        public void exito(String respuesta) {
                            ...
                            hud.updateArmaImage(armaTexture);
        ...
        for (Escalera escalera : escalera) {
            if (player.getHitbox().overlaps(escalera.getHitbox())){
                partidaInfo.setEnemigosAsesinados(enemigosAsesinados2);
                fondoSound.stop();
                nivelCompletadoSound.play();
                ((Game) Gdx.app.getApplicationListener()).setScreen(new GameScreen4(juego,partidaInfo,player,enemigosAsesinados2));
            }
        }
    }
