...
public class GameScreen2 implements Screen {
    ...
    private int enemigosAsesinados1;
    ...
    public GameScreen2(Game juego,PartidaInfo partidaInfo,Player player1,int enemigosAsesinados) {
        this.enemigosAsesinados1=enemigosAsesinados;
        this.juego = juego;
        ...
        mapa = manager.get("mapas/nivel2.tmx", TiledMap.class);
        ...
        for (MapObject object : enemigos) {
            if (object.getProperties().get("type", String.class).equals("Slime")) {
                ...
                Slime2 slime = new Slime2(x,y,collisionLayer);
    ...
    public void render(float delta) {
        ...
        if (player.morir()) {
            ...
            player.reiniciar();
            fondoSound.stop();
            ApiClient.actualizarEnemigos(partidaInfo.getPartidaId(), enemigosAsesinados1, new ApiListener() {
                @Override
    ...
    private void checkCollisions() {
        ...
        for (Escalera escalera : escalera) {
            if (player.getHitbox().overlaps(escalera.getHitbox())){
                partidaInfo.setEnemigosAsesinados(enemigosAsesinados1);
                fondoSound.stop();
                nivelCompletadoSound.play();
                ((Game) Gdx.app.getApplicationListener()).setScreen(new GameScreen3(juego,partidaInfo,player,enemigosAsesinados1));
            }
        }
    }
