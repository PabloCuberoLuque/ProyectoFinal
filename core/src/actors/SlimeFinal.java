...
public class SlimeFinal extends Actor {
    private int vida;
    private int xp;
    private int ataque;
    ...
    public SlimeFinal(float x, float y, TiledMapTileLayer collisionLayer) {
        this.vida = 60;
        this.xp = 60;
        this.ataque = 15;
        this.estadoActual = EstadoSlime.IDLE;
        this.direccionActual = DireccionSlime.ABAJO;
        this.hitbox = new Rectangle(x, y, 128, 128);
        this.muerto = false;
        ...
        Texture spritesheet = new Texture(Gdx.files.internal("Slime3.png"));
    ...
    public void render(SpriteBatch batch) {
        ...
        batch.draw(frameActual, posicion.x, posicion.y,128,128);
    }
