...
public class Slime extends Actor {
    ...
    private static final long INVULNERABILITY_DURATION = 2000; // 2 segundos en milisegundos
    private Sound movimientoSound;

    public Slime(float x, float y, TiledMapTileLayer collisionLayer) {
        this.vida = 10;
        this.xp = 4;
        this.ataque = 3;
        ...
        this.daño = false;
        this.lastHitTime = 0;
        movimientoSound= Gdx.audio.newSound(Gdx.files.internal("movimiento.mp3"));
        ...
        Texture spritesheet = new Texture(Gdx.files.internal("Slime.png"));
