...
public class Slime3 extends Actor {
    private int vida;
    private int xp;
    private int ataque;
    ...
    public Slime3(float x, float y, TiledMapTileLayer collisionLayer) {
        this.vida = 30;
        this.xp = 12;
        this.ataque = 12;
        ...
        Texture spritesheet = new Texture(Gdx.files.internal("SlimeFinal.png"));
